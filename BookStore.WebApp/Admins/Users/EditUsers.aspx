<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditUsers.aspx.cs" Inherits="BookStore.WebApp.Admins.Users.EditUsers" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="formbody">
            ...
            <ul class="forminfo">
                <li>
                    <label>用户编号:</label>
                    <asp:TextBox ID="UsersId" runat="server" ReadOnly="True" CssClass="dfinput"></asp:TextBox>
                </li>
                <li>
                    <label>邮箱地址:</label>
                ...
                <li>
                    <label>上传头像</label>
                    <img src="../../upload/users/<%=imgSrc %>" width="150" height="150"/>
